...
export default function InfoDialog({ close }: { close: () => void }) {
  return (
    <div className="max-w-[540px]">
      <h2 className="mt-5 text-center text-xl font-medium text-p12-success">What is P12 Arcana @ TI11?</h2>
      ...
      <h2 className="mt-12 text-center text-xl font-medium text-p12-orange">What is the prize pool?</h2>
      <p className="mt-4 text-sm leading-6">
