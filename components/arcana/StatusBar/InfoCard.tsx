...
export default function InfoCard({ data, level, onLevelClick }: InfoCardProps) {
  return (
    <div className="relative">
      ...
      <div className="relative ml-[52.5px] h-[160px] w-[175px] bg-gray-800 xs:ml-[9.87vw] xs:h-[29.87vw] xs:w-[32.5vw]">
        ...
        <p className="relative z-20 truncate px-2 pt-2 text-center text-p12-gold xs:text-xs">{data?.personName || '--'}</p>
