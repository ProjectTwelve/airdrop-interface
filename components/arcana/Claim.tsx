    ...
    >
      ...
      <div className="mt-2 px-[30px]">
        ...
        <div className="mt-8 h-[46px]">
          <button className="dota__gold dota__button--disable w-full py-3 leading-5">Claim</button>
        </div>
        <div className="relative mt-3 mb-3.5">
          ...
          <div className="absolute left-0 right-0 top-2 -z-10 mx-auto h-[4px] w-[60%] animate-ping-slow bg-p12-link blur-sm" />
        </div>
      </div>
    </div>
  );
