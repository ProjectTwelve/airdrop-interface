...
const PART_COUNT = {
  [PART_PROGRESS.PART1]: 1000,
  [PART_PROGRESS.PART2]: 10000,
  [PART_PROGRESS.PART3]: 30000,
  [PART_PROGRESS.PART4]: 50000,
  [PART_PROGRESS.PART5]: Infinity,
};
...
export default function Participant() {
  ...
  useEffect(() => {
    setPartStatus((status) => {
      ...
      if (count > PART_COUNT[PART_PROGRESS.PART1]) {
      ...
      if (count > PART_COUNT[PART_PROGRESS.PART2]) {
      ...
      if (count > PART_COUNT[PART_PROGRESS.PART3]) {
      ...
      if (count > PART_COUNT[PART_PROGRESS.PART4]) {
  ...
  return (
    <div className="w-full overflow-x-scroll">
      <div className="flex h-[120px] w-[1360px]">
          ...
          <div className="relative z-10">
            <div className="mt-4 ml-6">
              <div className="flex items-center">
                ...
                <p className="flex-1 text-center font-ddin text-[30px] font-bold leading-[30px] text-p12-success">
              ...
              <div className="mt-3 flex items-center">
                ...
                <div className="flex flex-1 items-center justify-center text-center font-ddin text-[42px] font-bold leading-[42px] text-p12-orange">
                  <div className="mr-1">
        ...
        <div className="relative -ml-[26px] w-[288px]">
          ...
          <div className="relative z-10">
            <div className="mt-4 h-[30px]">
              <p className="text-center font-ddin text-[30px] font-bold leading-[30px] text-p12-success">
              ...
              <div className="mt-3 flex items-center justify-center text-center font-ddin text-[42px] font-bold leading-[42px] text-p12-orange">
                <div className="mr-1">
