  ...
  return (
    <div className="p-6">
      ...
      <div>
        ...
        <p className="text-sm text-p12-sub leading-6">· Storing digital assets such as $P12, ETH and NFTs.</p>
        <p className="text-sm text-p12-sub leading-6">· Sending Blockchain transactions.</p>
      </div>
    </div>
  );
}
