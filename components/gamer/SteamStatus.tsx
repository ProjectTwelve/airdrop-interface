...
export default function SteamStatus() {
  ...
  const { data: gamerInfo } = useGamerInfo(account?.address);
  const [isSteamLogin] = useState(false);
  const [secretToken, steamSignIn] = useSteamSignIn();

  console.log('gamerInfo: ', gamerInfo, secretToken);
          ...
          <div className="py-8">
            ...
            <div className="h-[248px] rounded-2xl bg-p12-black/80 p-6">
              ...
              <div className="mt-[80px] flex items-center justify-center">
                <Button type="bordered" className="w-[260px]">
