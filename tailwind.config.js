  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'card-0-top': 'url(/img/poster/bg_0_top.webp)',
        'card-0-bottom': 'url(/img/poster/bg_0_bottom.webp)',
        'card-1-top': 'url(/img/poster/bg_1_top.webp)',
        'card-1-bottom': 'url(/img/poster/bg_1_bottom.webp)',
        'card-2-top': 'url(/img/poster/bg_2_top.webp)',
        'card-2-bottom': 'url(/img/poster/bg_2_bottom.webp)',
        'card-3-top': 'url(/img/poster/bg_3_top.webp)',
        'card-3-bottom': 'url(/img/poster/bg_3_bottom.webp)',
        'card-4-top': 'url(/img/poster/bg_4_top.webp)',
        'card-4-bottom': 'url(/img/poster/bg_4_bottom.webp)',
